            ...
            {isLoggedIn ? (
              ...
              <>
                ...
                <button
                  ...
                  className="hidden sm:block px-3 py-1.5 text-gray-700 font-bold hover:bg-gray-100 rounded-lg transition-all text-xs sm:text-sm"
                >
                  {t('auth.login')}
                </button>
                <button
                  onClick={onRegisterClick}
                  className="px-3 py-1.5 bg-gradient-to-r from-rose-500 to-pink-600 text-white rounded-lg font-bold hover:shadow-lg transition-all text-xs sm:text-sm whitespace-nowrap"
                >
                  {t('auth.register')}
                </button>
              </>
